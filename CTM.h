...
namespace tryn::utl::ctc
{
    ...
    struct state_t {
        static constexpr const char* varName;
    ...
    struct setter {
        ...
        static constexpr state_t<N, List, ID> state{
            ...
            static constexpr const unsigned varSize = VarSize;
        };
    };

    // TODO: AUTOMATE THIS
    template struct setter<0, nullptr, nullptr, 0u, std::tuple<>, tu_tag, 0>;     // E6
    template struct setter<0, nullptr, nullptr, 0u, std::tuple<>, tu_tag, 1>;
    template struct setter<0, nullptr, nullptr, 0u, std::tuple<>, tu_tag, 2>;
    template struct setter<0, nullptr, nullptr, 0u, std::tuple<>, tu_tag, 3>;
    template struct setter<0, nullptr, nullptr, 0u, std::tuple<>, tu_tag, 4>;
    template struct setter<0, nullptr, nullptr, 0u, std::tuple<>, tu_tag, 5>;
    template struct setter<0, nullptr, nullptr, 0u, std::tuple<>, tu_tag, 6>;
